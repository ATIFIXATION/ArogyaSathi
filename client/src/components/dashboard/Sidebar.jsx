...
export const Sidebar = ({ activeTab, onSelectTab, mobileOpen, onCloseMobile }) => {
  const navItems = [
    { id: 'overview', label: 'Overview', icon: Home },
    { id: 'risk-map', label: 'Healthcare Access Map', icon: Map },
    { id: 'cases', label: 'Citizen Cases', icon: Users },
    { id: 'alerts', label: 'Service Alerts', icon: Bell, badge: '12' },
    { id: 'referrals', label: 'Referrals & Follow-up', icon: RotateCw },
    { id: 'disease-trends', label: 'Service Trends', icon: TrendingUp },
    { id: 'reports', label: 'Reports', icon: FileText },
    { id: 'interventions', label: 'Interventions', icon: PlusCircle },
    { id: 'resources', label: 'Facilities & Resources', icon: FolderOpen },
  ...
  return (
    <>
      ...
      >
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3">
                    <Icon className={`w-[18px] h-[18px] ${isActive ? 'text-white' : 'text-[#C5D7C7]'}`} />
        ...
        {/* Bottom Section with Botanical Illustration & AI Insight Card */}
        <div className="relative p-3.5 mt-auto pt-2 flex flex-col justify-end">
          ...
          <div className="relative z-10 bg-[#2C4938]/95 backdrop-blur-sm border border-[#446652] rounded-xl p-3.5 shadow-lg">
            ...
            <p className="text-[11px] leading-relaxed text-[#D2E2D5]">
              Early insights. Stronger actions. Healthier communities.
            </p>
          </div>
        </div>
      </aside>

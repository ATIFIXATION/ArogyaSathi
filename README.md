...
SwasthyaSetu ("Health Bridge") is a healthcare coordination platform prototype built for **Smart India Hackathon 2026** (Problem Statement: **SIH26133**). It addresses coordination gaps that prevent rural and underserved citizens from accessing continuous public healthcare services.
...
![SwasthyaSetu Dashboard Overview](docs/screenshots/hero-dashboard.png)
...
SwasthyaSetu implements a role-based interface layer for three distinct actors in the public healthcare chain:
...
![SwasthyaSetu Landing Page](docs/screenshots/landing-page.png)
...
![SwasthyaSetu Citizen Dashboard](docs/screenshots/citizen-dashboard.png)
...
![SwasthyaSetu ASHA Worker Dashboard](docs/screenshots/asha-dashboard.png)
...
![SwasthyaSetu Health Officer Dashboard](docs/screenshots/health-officer-dashboard.png)
...
SwasthyaSetu is a prototype developed for Smart India Hackathon 2026.
